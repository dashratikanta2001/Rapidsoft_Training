...
public class StudentDto {
	...
	public StudentDto(Integer id, String name, int classNo, Date dob, String email, String phoneNo,
			String presentAddress, String permanentAddress, String bloodGroup, Date admissionDate, String fatherName,
			String motherName, String fatherPhoneNo, String motherPhoneNo) {
		super();
		this.id = id;
		this.name = name;
		this.classNo = classNo;
