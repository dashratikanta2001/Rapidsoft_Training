			...
			<div class="card-body">
				<div class="container mt-4">
					<form action="submitExam" method="post" modelAttribute="examForm">
						<input type="hidden" value="${test }" name="testNO"> <input
							...
							<c:forEach var="entry" items="${question.entrySet() }">
								...
								<div class="form-check">
									...
									<div class="form-group">
										<textarea class="form-control questionBox" readonly>${entry.key.question }</textarea>
									</div>
										...
										<c:forEach items="${entry.value }" var="op">
											<div class="list-group">
												<input type="radio" class="form-check-input"
													...
													id="${op.option_id }"
													name="selectedOptions[${entry.key.question_id}]" required
													value="${op.option_id}"> <label
													for="${op.option_id}"> <a
						...
						<div class="container text-center">
							...
							<input type="button" class="btn btn-danger btn-lg" value="Exit"
								onclick="confirmExit()">
						</div>
					</form>
				</div>
