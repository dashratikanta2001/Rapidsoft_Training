				...
				<div class="card">
					<div class="card-body">
						...
						<form action="handleform" method="post">
							...
							<div class="form-group">
								<label for="exampleInputId">Your Id</label> <input name="id"
									type="text" class="form-control" id="exampleInputId"
									aria-describedby="emailhelp" placeholder="Enter ID">
							</div>

							<div class="form-group">
								<label for="exampleInputDob">Your DOB</label> <input name="dob"
									type="text" class="form-control" id="exampleInputDob"
								...
								<div class="card-body">
									...
									<div class="form-group">
										<input name="address.street" type="text" class="form-control"
											id="exampleInputStreet" aria-describedby="emailhelp"
											placeholder="Enter street">
									</div>

									<div class="form-group">
										<input name="address.city" type="text" class="form-control"
											id="exampleInputCity" aria-describedby="emailhelp"
